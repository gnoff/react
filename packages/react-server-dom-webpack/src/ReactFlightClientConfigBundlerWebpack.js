...
import type {
  ...
  ClientReferenceManifestEntry as SharedClientReferenceManifestEntry,
...
export opaque type ClientReferenceManifestEntry = SharedClientReferenceManifestEntry;
...
export function resolveClientReference<T>(
  ...
  if (bundlerConfig) {
    ...
    if (isAsyncClientReference(metadata)) {
      return [resolvedModuleData.id, resolvedModuleData.chunks, name, true];
    } else {
